    ...
    begin
      ...
      if (:options = '[]') then
        CALL SYSTEM$SEND_EMAIL(
            'email_integration',
            'sudhir_phanse@hotmail.com', -- INSERT YOUR EMAIL HERE
